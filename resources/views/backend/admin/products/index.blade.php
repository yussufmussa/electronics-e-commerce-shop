        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="table-responsive">
                        <table id="categoryDT" class="table table-bordered dt-responsive nowrap w-100">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$key + 1}}</td>
                                    <td><img src="{{asset('photos/thumbnails/'.$product->thumbnail)}}" class="img-fluid img-responsive img-thumbnail" height="200px" width="200px"></td>
                                    <td>{{$product->name}}</td>
                                    <td>{{$product->category->name}}</td>
                                    <td>{{number_format($product->price)}}</td>
                                    <td>
                                        <a href="{{route('admin.products.edit', $product->id)}}" class="btn btn-sm btn-primary">Edit</a>
                                        <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal{{$product->id}}">Del</button>
                                        <div id="deleteModal{{$product->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <form action="{{route('admin.products.destroy', $product->id)}}" method="post">@csrf
                    ...
                    @else
                    <tr>
                        <td colspan="4" class="text-center"><span class="text-danger">Add new Product </span> <a href="{{route('admin.products.create')}}">here</a></td>
                    </tr>
                    @endif
                    </tbody>
                    </table>
...
<script>
    $(document).ready(function() {
        ...
        var title = 'Product_List_' + date_footer;
        ...
        $('#categoryDT').DataTable({
            ...
            buttons: [{
                    ...
                    buttons: [{
                        ...
                        },
                        {
                            ...
                            customize: function(doc) {
                                ...
                                doc.content[1].table.widths = ['10%', '60%', '10%', '10%']
                ...
                {
                    text: '<a href"add.php">Add Product</a>',
