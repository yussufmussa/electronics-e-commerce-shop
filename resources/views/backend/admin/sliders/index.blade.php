            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="table-responsive">
                        <table id="sliderDT" class="table table-bordered dt-responsive nowrap w-100">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Photo</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$key + 1}}</td>
                                    <td><img src="{{asset('photos/sliders/'.$slider->name)}}" style="height: 100px; height:100px;"></td>
                                    <td>
                                        <a href="{{route('admin.sliders.edit', $slider->id)}}" class="btn btn-sm btn-primary">Edit</a>
                                        <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal{{$slider->id}}">Del</button>
                                        <div id="deleteModal{{$slider->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <form action="{{route('admin.sliders.destroy', $slider->id)}}" method="post">@csrf
                    ...
                    @else
                    <tr>
                        <td colspan="4" class="text-center"><span class="text-danger">Create slider</span> <a href="{{route('admin.sliders.create')}}">here</a></td>
                    </tr>
                    @endif
                    </tbody>
                    </table>
...
<script>
    $(document).ready(function() {
        ...
        var title = 'All_slider_List_' + date_footer;
        ...
        $('#sliderDT').DataTable({
            ...
            buttons: [{
                    ...
                    buttons: [{
                        ...
                        },
                        {
                            ...
                            customize: function(doc) {
                                ...
                                doc.content[1].table.widths = ['10%', '40%', '40%', '10%']
                ...
                {
                    text: '<a href"add.php">Add slider</a>',
